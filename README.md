...
| [`config`](src/rescue_vision/config/README.md) | 已实现 | schema v10 配置、UART/远程/motion/几何/模型和算法装配 |
...
| [`perception`](src/rescue_vision/perception/README.md) | 已实现基础设施 | Pose 框/K0、ROI HSV 主分类与颜色分割、假后端和 Hailo 后端；正式模型与现场阈值待验证 |
